...
insert into users (id, type, username, hash, first_name, last_name, email, unit_id) values
    (6, 'SUPERVISOR', 'ramin', '$2a$10$9PJIPq9PMYHd9L8kb66/Nuu7DDQqq29eOsVF1F8SnPZ2UfD6KC/ly',
        'Ravi', 'Amin', 'ramin@calstate.edu', 5);
insert into users (id, type, username, hash, first_name, last_name, email, unit_id) values
...
insert into users (id, type, username, hash, first_name, last_name, email, unit_id) values
    (15, 'TECHNICIAN', 'rpatel', '$2a$10$d8lhouzPhxZ.nLCaqjh5gevTyA3tZDUMwuy2WAsWAm.i/ag/btcxe',
        'Rutvi', 'Patel', 'rpatel@calstatela.edu', 5);
insert into users (id, type, username, hash, first_name, last_name, email, unit_id) values
...
insert into unit_technicians (unit_id, technician_id) values (1,11);
insert into unit_technicians (unit_id, technician_id) values (2,12);
insert into unit_technicians (unit_id, technician_id) values (3,13);
insert into unit_technicians (unit_id, technician_id) values (4,14);
insert into unit_technicians (unit_id, technician_id) values (5,15);
insert into unit_technicians (unit_id, technician_id) values (6,16);
insert into unit_technicians (unit_id, technician_id) values (7,17);
insert into unit_technicians (unit_id, technician_id) values (8,18);
insert into unit_technicians (unit_id, technician_id) values (9,19);